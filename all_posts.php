...
<section class="all-posts">
   ...
   <div class="heading">
      <h1>All Movies</h1>
      <input type="text" id="search" class="search-bar" placeholder="Search for movies..." onkeyup="searchMovies()">

   </div>

   <div class="box-container" id="posts-container">
...
function searchMovies() {
    var searchQuery = document.getElementById("search").value.trim(); // Get and trim the search input
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            // Replace the contents of the posts-container div with the response
    ...
    xhttp.send("search=" + encodeURIComponent(searchQuery)); // Send search query to search.php
}
